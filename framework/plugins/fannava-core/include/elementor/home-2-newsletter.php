 ...
 * @since 1.0.0
 */
class Fannava_Home_2_Newsletter extends Widget_Base {
	...
	public function get_title() {
		return __( 'Home 2 Newsletter', 'fannavacore' );
	}
	...
	protected function render() {
		...
		?>
			...
			<div class="subscribe-area style-2">
				<div class="container">
...
$widgets_manager->register( new Fannava_Home_2_Newsletter() );