 ...
 * @since 1.0.0
 */
class Fannava_Home_1_Talk_To_Us extends Widget_Base {
	...
	public function get_title() {
		return __( 'Home 1 Talk To Us', 'fannavacore' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
            'fannava_talk_to_us_phone_number_color',
            [
...
$widgets_manager->register( new Fannava_Home_1_Talk_To_Us() );