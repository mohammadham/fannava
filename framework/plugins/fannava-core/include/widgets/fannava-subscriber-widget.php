<?php
class Fannava_Subscriber_Widget extends WP_Widget {

    public function __construct() {
        parent::__construct('fannava-subscriber-footer', 'Fannava Footer Subscriber', array(
			'description'	=> 'Footer Subscriber Widget by Fannava'
		));
    }
    ...
    public function form( $instance ) {
        ...
        ?>
			<p><label for="title"><?php esc_html_e( 'Title:', 'fannavacore' );?></label></p>
...
add_action('widgets_init', function(){
	register_widget('Fannava_Subscriber_Widget');
});
