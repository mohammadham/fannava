...
// info
$fannava_topbar_switch = get_theme_mod( 'fannava_topbar_switch', false );
...
// social setting
$fannava_topbar_social_switch = get_theme_mod( 'fannava_topbar_social_switch', false );
...
<header class="header-area style-1 <?php if ( is_user_logged_in() ) { echo 'login'; } ?>">
    <!-- Header Top Start -->
    <?php if ( !empty( $fannava_topbar_switch ) ): ?>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="te-header-top-wrapper">
                            ...
                            <div class="header-top-info">
                                <?php if ( !empty( $fannava_topbar_social_switch ) ): ?>
            ...
            <div class="te-menu-sidebar-content">
                <div class="te-menu-sidebar-single-widget">
                    ...
                    <?php if ( !empty( $fannava_side_info_social_switch ) ): ?>
                        <div class="te-social-profile">
                            <?php if ( !empty( $fannava_fb_url ) OR !empty( $fannava_twitter_url ) OR !empty( $fannava_linkedin_url ) OR !empty( $fannava_youtube_url )): ?>
                                <?php if ( !empty( $fannava_fb_url ) ): ?>
                                    <a href="<?php echo esc_html($fannava_fb_url); ?>"><i class="fa-brands fa-facebook-f"></i></a>
                                <?php endif; ?>
                                <?php if ( !empty( $fannava_twitter_url ) ): ?>
