...
$fannava_blog_date = get_theme_mod('fannava_blog_date', true);
$fannava_blog_comments = get_theme_mod('fannava_blog_comments', true);
$fannava_blog_cat = get_theme_mod('fannava_blog_cat', true);
?>

<div class="te-post-meta">
    <?php if ( !empty($fannava_blog_cat) ): ?>
